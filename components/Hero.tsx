      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold text-white leading-tight mb-12 tracking-tight whitespace-nowrap">
            Bespoke <span className="italic font-light text-(--accent)">Estates.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-start gap-8">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-5 bg-white text-black text-xs font-black tracking-[0.2em] rounded-none hover:bg-(--accent) hover:text-white transition-all duration-300 shadow-2xl"
            >
            ...
            >
              ABOUT
              <div className="w-12 h-px bg-white/30 group-hover:w-20 group-hover:bg-(--accent) transition-all duration-500"></div>
            </motion.a>
          </div>
        </motion.div>
      </div>
